  ...
  return (0, import_jsx_runtime51.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime51.jsx)(InputAdornmentRoot, _extends({
      ...
      children: typeof children === "string" && !disableTypography ? (0, import_jsx_runtime51.jsx)(Typography_default, {
        ...
        children
      }) : (0, import_jsx_runtime52.jsxs)(React74.Fragment, {
...
var OutlinedInput = React79.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime58.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime58.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime57.jsxs)(React79.Fragment, {
        children: [label, " ", "*"]
      })) : label,
  ...
  return (0, import_jsx_runtime62.jsxs)(React81.Fragment, {
    children: [(0, import_jsx_runtime61.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span8 || (_span8 = (0, import_jsx_runtime61.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UGPKEWQT.js.map
